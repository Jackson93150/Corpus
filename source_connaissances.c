...
int recuperer_contenu_site_diff(char *lien, char *nom_fichier_fin_sites)
{
   ...
   char *balise_debut,*debut, *balise_debut2, *debut3, *balise_debut3, *debut2,*balise_debut4, *debut4, *balise_debut5, *debut5,*balise_debut6, *debut6,*balise_debut7, *debut7;
   char ligne [1024];
   int temp = nbr_site;   
   ...
   { 
     ...
     {   
      ...
      debut7 = strstr(ligne, balise_debut7);
       ...
       if(debut)
        ...
        {
               printf("-Les fichiers provenant du site youtube ne peuvent pas etre traites\n");
        }
        else
        {
...
int conserver_lien(char * nom_fichier, char * nom_fichier_2, int nombre_source)
{
   ...
   taille_fichier = ftell (fichier);          // determine la taille du fichier
...
int faire_corpus(char *fichier_dico, char *nom_rep_corpus)
{
   ...
   { 
	...
	/*PRECISER DOMAINE DE RECHERCHE DU CORPUS ICI*/
        aux=concatene("http://www.google.com/search?q=",ligne);
  	...
  	// printf("\n\n source_google :%s\n\n",source_google);
        ...
        // printf("saluut tout le modn\n");         // printf("%s",source_google);
  	// printf("\n\ndossier :%s\n\n",dossier);
  	// printf("\n\n source_lien_google :%s\n\n",source_lien_google);
  	...
  	// printf("\n\n source_lien_connaissance :%s\n\n",source_lien_connaissance);
